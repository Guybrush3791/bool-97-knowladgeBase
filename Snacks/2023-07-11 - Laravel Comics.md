...
Create poi **una rotta per visualizzare la lista di tutti i fumetti** recuperati dalla variabile `$fumetti` messa in `web.php` come visto a lezione.
...
### Assets
Vedi [[2023-07-11 - Laravel Comics Assets|Laravel Comics Assets]]
